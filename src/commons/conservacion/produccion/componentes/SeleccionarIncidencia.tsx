...
import { set_current_incidencia, set_incidencias } from '../store/slice/produccionSlice';
...
const SeleccionarIncidencia = ({
    ...
    const { incidencias, nurseries, current_incidencia, changing_person, current_siembra_material_vegetal } = useAppSelector((state) => state.produccion);
    ...
    useEffect(() => {
        if(current_incidencia.id_incidencia !== null){
          if (current_incidencia.ruta_archivo_soporte !== null && current_incidencia.ruta_archivo_soporte !== undefined) {
                ...
                <BuscarModelo
                    ...
                    form_inputs={[
                        ...
                        },
                        {
                            ...
                            default_value: "",
                            rules: { required_rule: { rule: false, message: "Consecutivo incidencia requerido" } },
                        ...
                        },
                        {
                            ...
                            default_value: "",
                            rules: {required_rule: { rule: true, message: "Tipo de incidencia requerido" }},
                            label: "Tipo incidencia",
                            helper_text: "",
                            disabled: false,
                            select_options: [{ label: "Actividad", value: "A" },{ label: "Seguimiento", value: "S" }],
                            option_label: "label",
                            option_key: "value"
                          },
                        {
                            ...
                            default_value: "",
                            rules: { required_rule: { rule: false, message: "Nombre de incidencia requerido" } },
