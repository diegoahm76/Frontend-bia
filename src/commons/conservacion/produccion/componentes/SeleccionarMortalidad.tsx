...
import { set_current_mortalidad, set_mortalidades } from '../store/slice/produccionSlice';

import { useAppDispatch, useAppSelector } from '../../../../hooks';
import { useEffect, useState } from 'react';
// import DeleteIcon from '@mui/icons-material/Delete';
// import EditIcon from '@mui/icons-material/Edit';
import { get_mortalidades_service, get_mortalidad_nro_service, get_nurseries_mortalidad_service } from '../store/thunks/produccionThunks';
...
const SeleccionarMortalidad = ({
    ...
    const { mortalidades, nurseries, current_mortalidad, changing_person } = useAppSelector((state) => state.produccion);
                ...
                <BuscarModelo
                    ...
                    form_inputs={[
                        ...
                        },
                        {
                            ...
                            default_value: "",
                            rules: { required_rule: { rule: false, message: "Consecutivo mezcla requerido" } },
