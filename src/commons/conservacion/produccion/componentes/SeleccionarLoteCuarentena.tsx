...
import {  set_current_siembra_material_vegetal, set_siembras_material_vegetal } from '../store/slice/produccionSlice';
import { useAppDispatch, useAppSelector } from '../../../../hooks';
import { useEffect, useState } from 'react';
import { get_lots_code_service, get_lots_service } from '../store/thunks/produccionThunks';
...
const SeleccionarLoteSiembra = () => {
    ...
    const { current_nursery, current_siembra_material_vegetal, siembras_material_vegetal, current_incidencia } = useAppSelector((state) => state.produccion);
