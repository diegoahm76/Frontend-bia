...
import { set_persons, set_planting_person } from '../store/slice/materialvegetalSlice';
import { useAppDispatch, useAppSelector } from '../../../../hooks';
import { get_person_document_service, get_person_id_service, get_persons_service } from '../store/thunks/materialvegetalThunks';
...
const PersonaSiembra = ({
    ...
    const { planting_person, current_planting, persons } = useAppSelector((state) => state.material_vegetal);
