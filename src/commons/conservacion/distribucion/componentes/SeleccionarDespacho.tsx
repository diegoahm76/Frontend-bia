...
import { set_current_despacho, set_despachos } from '../store/slice/distribucionSlice';
...
const SeleccionarDespacho = ({
    ...
    const { despachos, current_despacho, transfer_person, origin_nursery } = useAppSelector((state) => state.distribucion);
    ...
    useEffect(() => {
        if(current_despacho.id_despacho_viveros !== null){
          if (current_despacho.ruta_archivo_con_recibido !== null && current_despacho.ruta_archivo_con_recibido !== undefined) {
