...
import { set_nuevos_viveristas, set_current_nuevo_viverista } from '../store/slice/viveroSlice';
import { useAppDispatch, useAppSelector } from '../../../../hooks';
import { get_viverista_document_service, get_nuevos_viveristas_service } from '../store/thunks/gestorViveroThunks';
...
const SeleccionarNuevoViverista = () => {
    ...
    const { control: control_persona, reset: reset_persona, getValues: get_values } = useForm<IObjBuscarNuevoViverista>();
    const { current_nuevo_viverista, nuevos_viveristas } = useAppSelector((state) => state.nursery);
    ...
    const get_personas: any = (async () => {
        ...
        void dispatch(get_nuevos_viveristas_service(type, document, primer_nombre, primer_apellido, segundo_apellido, segundo_nombre))
    })
