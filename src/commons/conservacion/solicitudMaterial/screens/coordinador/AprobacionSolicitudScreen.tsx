...
import { aprobacion_solicitud_coordinador, get_bienes_solicitud, get_funcionario_id_service, get_nurcery, get_person_id_service, get_solicitud_aprobacion_coordinador, get_uni_organizacional } from '../../store/thunks/solicitudViveroThunks';
...
const AprobacionSolicitudCoordinadorScreen = () => {
  ...
  const on_submit_aprobacion = (data: IObjSolicitudVivero): void => {
    ...
    void dispatch(aprobacion_solicitud_coordinador(form_data, data.id_solicitud_vivero))
  }
