...
import { inputs_funcionario_responsable, interface_busqueda_responsable, interface_tipos_documentos, response_busqueda_responsable, response_tipos_documentos } from '../interfaces/types';
import { get_obtener_responsables, get_obtener_tipos_documentos } from '../thunks/devolucion_activos';
...
interface props {
  ...
  set_inputs_funcionario_responsable: React.Dispatch<React.SetStateAction<inputs_funcionario_responsable>>;
}
