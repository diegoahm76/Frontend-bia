...
import { get_obtener_persona_solicita, get_obtener_tipos_documentos } from '../thunks/despachos_autorizados';
...
const ModalBusquedaPersona: React.FC<props> = ({
  ...
  const enviar_persona_solicita_seleccionado = () => {
    if (Object.keys(data_persona_responsable_temp).length !== 0) {
      ...
      set_data_persona_solicita(data_persona_responsable_temp);
