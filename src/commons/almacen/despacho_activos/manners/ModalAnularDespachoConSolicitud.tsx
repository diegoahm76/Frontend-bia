...
interface props {
  set_mostrar_modal_anular_despacho: React.Dispatch<React.SetStateAction<boolean>>;
  mostrar_modal_anular_despacho: boolean;
  id_solicitud_activo: number | null;
  get_obtener_solicitudes_activos_fc: () => void;
}

// eslint-disable-next-line @typescript-eslint/naming-convention
const ModalAnularDespachoConSolicitud: React.FC<props> = ({
  set_mostrar_modal_anular_despacho,
  mostrar_modal_anular_despacho,
  ...
  const anular_despacho_con_solicitud = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        await dispatch(put_anular_despacho_con_solicitud(id_solicitud_activo,{
          ...
          .then((response: any) => {
            if (Object.keys(response).length !== 0) {
              ...
              get_obtener_solicitudes_activos_fc();
              set_mostrar_modal_anular_despacho(false);
              limpiar_form();
  ...
  return (
    <>
      <Dialog
        open={mostrar_modal_anular_despacho}
        onClose={() => {
          set_mostrar_modal_anular_despacho(false);
        }}
            ...
            <Grid container item xs={12} spacing={1} sx={{display:'flex', justifyContent:'end'}}>
              ...
              <Grid item xs={12} md={2}>
                <Button
                  ...
                  variant="contained"
                  startIcon={<ClearIcon />}
                  onClick={()=>set_mostrar_modal_anular_despacho(false)}
                >
                  Salir
                </Button>
              </Grid>
...
export default ModalAnularDespachoConSolicitud;