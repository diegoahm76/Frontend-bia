...
import { interface_busqueda_articulos, response_busqueda_articulos } from '../interfeces/types';
import { get_obtener_articulos } from '../thunks/despacho_solicitudes';
...
interface props {
  ...
  set_articulo_seleccionado: React.Dispatch<React.SetStateAction<interface_busqueda_articulos>>;
}

// eslint-disable-next-line @typescript-eslint/naming-convention
const ModalBuscarArticulo: React.FC<props> = ({set_mostrar_busqueda_articulo,mostrar_busqueda_articulo,set_articulo_seleccionado}) => {
  ...
  const [data_articulos, set_data_articulos] = useState<interface_busqueda_articulos[]>([
    undefined as unknown as interface_busqueda_articulos,
    undefined as unknown as interface_busqueda_articulos,
    undefined as unknown as interface_busqueda_articulos,
    undefined as unknown as interface_busqueda_articulos,
    undefined as unknown as interface_busqueda_articulos,
  ...
  const [fila_seleccionada_temp, set_fila_seleccionada_temp] = useState<interface_busqueda_articulos>(Object);
  ...
  const enviar_articulo_encontrado = () => {
    if(Object.keys(fila_seleccionada_temp).length === 0){
      ...
      set_articulo_seleccionado(fila_seleccionada_temp);
            ...
            <Box
              ...
              <Grid item xs={12} md={2} sx={{
                ...
                <Button
                  ...
                  variant='contained'
                  startIcon={<SaveIcon />}
                  disabled={Object.keys(fila_seleccionada_temp).length === 0}
