        ...
        >
            <Grid item xs={12} sm={12}>
                ...
                >
                    ...
                    {download_new_pdf_props({ nurseries: props.resultado_busqueda, columns: props.cols,filtrers: props.filtros_pdf, title: 'Tablero de control - Almacén',nombre_archivo: props.nombre_archivo })}
