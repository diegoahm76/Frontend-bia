        ...
        <>
            ...
            >
                <Grid item xs={12}>
                    ...
                    <BusquedaArticuloComponent tipo_articulo={"otros activos"} parent_details={set_details_state} user_info_prop={set_user_info_state} limpiar_formulario={limpiar_formulario} />
                </Grid>
            </Grid>
            <Grid container
                sx={{
