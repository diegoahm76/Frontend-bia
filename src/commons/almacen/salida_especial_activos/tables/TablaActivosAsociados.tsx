...
const TablaActivosAsociados: React.FC<props> = ({
  ...
  loadding_tabla_activos_asociados,
    ...
    console.log(data_activos_asociados);
  ...
  const agregar_activos = (params: interface_activos_asociados) => {
    ...
    set_data_activos_asociados(data_activos_asociados.filter(row => row.id_item_entrada_almacen !== params.id_item_entrada_almacen));
  }
