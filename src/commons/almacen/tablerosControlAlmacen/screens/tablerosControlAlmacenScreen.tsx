...
import { obtener_consumo_bienes_und, obtener_control_stock, obtener_mantenimientos_realizados, obtener_movimientos_incautados, obtener_mtto_programados, obtener_tipos_mantenimiento, obtener_unidades_organizacionales } from "../thunks/tablerosControlAlmacen";
...
export const TablerosControlAlmacenScreen: React.FC = () => {
  ...
  // Listas
  const lt_tablero_control = [{ id: 'CBU', value: 'Consumo de bienes por unidad' }, { id: 'MP', value: 'Mantenimientos programados' }, { id: 'CS', value: 'Control de stock' }, { id: 'MSI', value: 'Movimientos sobre incautados' }, { id: 'MR', value: 'Mantenimientos realizados' }]
  ...
  const [seleccion_tipo_mtto, set_seleccion_tipo_mtto] = useState<string>("BN");
  const [seleccion_tipo_bien, set_seleccion_tipo_bien] = useState<string>("BN");
