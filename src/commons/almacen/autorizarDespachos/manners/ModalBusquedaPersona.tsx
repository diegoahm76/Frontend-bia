...
import { get_obtener_persona_solicita, get_obtener_tipos_documentos } from '../thunks/autorizar_despachos';
...
const ModalBusquedaPersona: React.FC<props> = ({
  ...
  const [data_personas_solicita, set_data_personas_solicita] = useState<interface_busqueda_persona_solicita[]>([]);
    ...
    dispatch(get_obtener_persona_solicita(
      ...
      if (Object.keys(response).length !== 0) {
        if (response.data.length !== 0) {
          set_data_personas_solicita(response.data);
          set_loadding_tabla(false);
        } else {
          set_data_personas_solicita([]);
    ...
    <>
      <Dialog
        ...
        <DialogContent>
          ...
          >
            <Title title='Búsqueda de persona solicita' />
            <Box
              component="form"
              noValidate
              autoComplete="off"
            ...
            <Grid item container xs={12} sx={{
              ...
              <TablaModalBusquedaPersona
                ...
                data_personas_solicita={data_personas_solicita}
