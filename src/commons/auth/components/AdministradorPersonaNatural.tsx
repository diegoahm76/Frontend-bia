...
import type { ClaseTercero, DataPersonas, DatosVinculacionCormacarena, InfoPersona, keys_object } from "../../../interfaces/globalModels";
import {
...
export const AdministracionPersonasScreenNatural: React.FC<Props> = ({
    ...
    const {
        ...
        // set_cod_departamento_expedicion,
    ...
    // actualiza los datos
    const on_submit_update_natural = async():Promise<void> => {
        ...
        <>
            <Grid item xs={12} spacing={2}>
                <Box component="form"
                    ...
                    onSubmit={handle_submit(on_submit_update_natural)}>
                                            ...
                                            <>
                                                ...
                                                <Grid item xs={12} sm={6}>
                                                    <TextField
                                                        ...
                                                        onCopy={(e: any) => e.preventDefault()}
                                                        value={datos_persona.telefono_celular_empresa}
