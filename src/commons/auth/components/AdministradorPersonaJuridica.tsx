...
import { consultar_datos_persona, consultar_datos_persona_basicos } from "../../seguridad/request/Request";
...
export const AdministracionPersonasScreenJuridica: React.FC<Props> = ({
    ...
    const [datos_represnetante, set_datos_represnetante] = useState<DataPersonas>();
    const [datos_represnetante_basicos, set_datos_represnetante_basicos] = useState<InfoPersona>();
    ...
    const get_datos_basicos_representante_legal = async (num_doc: string, tipo_doc: string): Promise<void> => {
        try {
            ...
            set_datos_represnetante_basicos(response)
    ...
    // useEffect(() => {
    //     if (datos_persona?.representante_legal !== undefined) {
    //         const id: number | undefined = datos_persona?.representante_legal
    //         if (id !== 0){
    //             void get_datos_representante_legal(id)
    //         }
    //     } else {
                                            ...
                                            <>
                                                ...
                                                <Grid item xs={12} sm={6}>
                                                    <TextField
                                                        ...
                                                        margin="dense"
                                                        required
                                                        defaultValue={datos_represnetante?.numero_documento}
                                                        disabled
                                                    />
                                                </Grid>
                                                <Grid item xs={12} sm={6}>
                                                    <TextField
                                                        ...
                                                        required
                                                        autoFocus
                                                        defaultValue={datos_represnetante_basicos?.nombre_completo}
                                                        disabled
                                                    />
                                                </Grid>
                                                <Grid item xs={12} sm={6}>
                                                    <TextField
                                                        ...
                                                        required
                                                        autoFocus
                                                        defaultValue={datos_represnetante?.direccion_notificaciones}
                                                    />
                                                </Grid>
                                                <Grid item xs={12} sm={6}>
                                                    <TextField
                                                        ...
                                                        required
                                                        autoFocus
                                                        defaultValue={datos_represnetante?.telefono_celular}
                                                    />
                                                </Grid>
                                                <Grid item xs={12} sm={6}>
                                                    <CustomSelect
                                                        ...
                                                        label="Ciudad"
                                                        name="cod_municipio_notificacion_nal"
                                                        value={datos_represnetante?.cod_municipio_notificacion_nal}
                                                        options={ciudad_notificacion_opt}
                                                        loading={loading}
                                                        disabled={datos_represnetante?.cod_departamento_notificacion === '' ?? true}
                                                        required={true}
                                                        errors={errors}
                                                        register={register}
                                                    />
                                                ...
                                                <Grid item xs={12} sm={6}>
                                                    <TextField
                                                        ...
                                                        required
                                                        autoFocus
                                                        defaultValue={datos_represnetante?.email_empresarial}
                                                    />
                                                </Grid>
                                                <Grid item xs={12}>
