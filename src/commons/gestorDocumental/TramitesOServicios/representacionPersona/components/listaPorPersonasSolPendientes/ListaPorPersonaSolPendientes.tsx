  ...
  const columnsMain = [
    ...columnsOpas,
    {
      ...
      renderCell: (params: any) => (
        <>
          <Tooltip title="Seleccionar OPA (búsqueda de requerimientos pendientes de respuesta)">
            <IconButton
              onClick={async () => {
                try {
          ...
          <Tooltip title="Responder requerimiento de la OPA seleccionada">
            <IconButton
              onClick={async () => {
                ...
                navigate(
                  `/app/gestor_documental/tramites/respuesta_requerimiento_opa/formulario_usuario/`
                );
                dispatch(
                  setCurrentPersonaRespuestaUsuario({
                    ...currentPersonaRespuestaUsuario,
      ...
      {eigthLoading ? (
        ...
        >
          <Typography variant="body2" color="textSecondary">
            ...
            requerimiento para la opa seleccionada y / o no se ha realizado la
            búsqueda búsqueda
          </Typography>
        </Grid>
      )}
