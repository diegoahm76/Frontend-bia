...
import { resetItems } from '../../../../../../../respuestaRequerimientoOpa/toolkit/slice/ResRequerimientoOpaSlice';
  ...
  /*  formData.append('id_tarea', currentElementBandejaTareasPqrsdfYTramitesYOtrosYOpas?.id_tarea_asignada);*/
    ...
    postResponderRequerimientoUsuario(formData, setLoadingButton)
      .then(() => {
        ...
        //setInfoReset({});
        dispatch(resetItems());
        navigate('/app/gestor_documental/tramites/respuesta_permiso_menor/');
        Swal.fire({
