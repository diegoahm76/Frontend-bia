                            ...
                            {datos_tabla?.length !== 0 ? (
                                <DataGrid
                                    ...
                                    rows={[
                                        ...
                                        { attribute: "Item Ya Usado", value: datos_tabla ? datos_tabla[0]?.item_ya_usado : "" },
                                        { attribute: "Fecha Última Configuración", value: datos_tabla ? datos_tabla[0]?.fecha_ult_config_implement : "" },
                                        { attribute: "Consecutivo Actual", value: datos_tabla ? datos_tabla[0]?.consecutivo_actual : "" },
                                        { attribute: "Fecha Consecutivo Actual", value: datos_tabla ? datos_tabla[0]?.fecha_consecutivo_actual : "" },
