...
import { Pqr,TipoPQRSDF } from "../interfaces/types";
...
const cargarAsignaciones = async ({
    ...
    try {
        const response = await api.get(`/gestor/radicados/otros/consulta-estado-otros/?radicado=${formData.radicado}&fecha_radicado_desde=${formData.fecha_desde}&fecha_radicado_hasta=${formData.fecha_hasta}&estado_solicitud=${formData.estado}`);
