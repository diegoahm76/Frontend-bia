...
export const ConsultaOtros: React.FC = () => {
    ...
    const tipoSolicitudField = 'Tipo de Solicitud';
    const columns = [
        { field: tipoSolicitudField, headerName: 'Tipo de Solicitud', width: 220, flex: 1, },
    ...
    const handleSearch = (): void => {
        ...
        const filteredEncuestas = asignaciones.filter(asignaciones =>
            asignaciones.Titular.toLowerCase().includes(formData.tipo_solicitud.toLowerCase())
        );
