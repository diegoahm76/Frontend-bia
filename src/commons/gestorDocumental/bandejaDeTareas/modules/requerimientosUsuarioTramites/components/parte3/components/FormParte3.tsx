...
import { addAnexo, deleteAnexo, editAnexo, setCurrentAnexo, setMetadatos, setViewMode } from '../../../../requerimientosUsuario/toolkit/slice/RequerimientoUsarioSlice';
...
export const FormParte3 = ({
  ...
  const { currentAnexo, anexosCreados, metadatos, viewMode } = useAppSelector(
    (state: any) => state.RequerimientoUsarioOpasSlice
  );
