...
export const ModuleInfoTareaOtros = (props: any): JSX.Element => {
          ...
          >
            ...
            <Grid item xs={12} sm={4}>
              <TextField
                ...
                size="small"
                variant="outlined"
                value={formatDate(infoTarea?.fecha_registro) ?? ''}
                InputLabelProps={{ shrink: true }}
              />
            </Grid>
            ...
            <Grid item xs={12} sm={4}>
              <TextField
                ...
                size="small"
                variant="outlined"
                value={formatDate(infoTarea?.fecha_radicado) ?? ''}
                InputLabelProps={{ shrink: true }}
              />
            </Grid>
            ...
            <Grid item xs={12} sm={4}>
              <TextField
                ...
                size="small"
                variant="outlined"
                value={infoTarea?.forma_presentacion ?? ''}
                InputLabelProps={{ shrink: true }}
              />
            </Grid>
            ...
            <Grid item xs={12} sm={4}>
              <TextField
                ...
                size="small"
                variant="outlined"
                value={infoTarea?.medio_solicitud ?? ''}
                InputLabelProps={{ shrink: true }}
              />
            </Grid>
            ...
            <Grid item xs={12} sm={4}>
              <TextField
                ...
                size="small"
                variant="outlined"
                value={infoTarea?.persona_srecibe ?? 'N/A'}
                InputLabelProps={{ shrink: true }}
              />
            </Grid>
            ...
            <Grid item xs={12} sm={4}>
              <TextField
                fullWidth
                disabled
                label="Nombre sucursal recepción física"
                size="small"
                variant="outlined"
                value={infoTarea?.nombre_sucursal_recepciona_fisica ?? ''}
                InputLabelProps={{ shrink: true }}
              />
            </Grid>
