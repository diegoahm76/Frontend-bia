...
export const VistaTareasOtros = (): JSX.Element => {
  ...
  useEffect(() => {
    ...
    console.log('id_PQRSDF', id_OTROS);
  ...
  return (
    <>
      ...
      <ModuleInfoTareaOtros
        infoTitle={`Información de la tarea`}
        titleOpcion={`Listado de anexos de la solicitud de otros con identificación: ${id_OTROS}`}
      />
    </>
  );
};
