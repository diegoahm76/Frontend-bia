...
import { estado, Pqr, TipoPQRSDF, organigrama, AsignacionEncuesta, FormData } from '../interface/types';
import { Button, ButtonGroup, Divider, FormControl, Grid, InputLabel, MenuItem, Select, TextField, } from '@mui/material';
import { cargarAsignaciones, cargarestado, cargarorganigrama, fetchSpqrs, fetchTipoPQRSDF } from '../services/consultainterno.service';
import { useSelector } from 'react-redux';
import { AuthSlice } from '../../../auth/interfaces';

export const ConsultaEstadoPQR: React.FC = () => {
    const { userinfo: { nombre_de_usuario, id_persona } } = useSelector((state: AuthSlice) => state.auth);
    ...
    const columns = [
        ...
        { field: 'Tipo de Solicitud', headerName: 'Tipo de Solicitud', width: 150, flex: 1, },
        ...
        {
            field: 'Fecha de Radicado', headerName: 'Fecha de Radicado', width: 220, flex: 1, valueFormatter: (params: { value: string | number | Date | null | undefined }) => {
        ...
        { field: 'Ubicacion en la corporacion', headerName: 'Ubicacion en la corporacion', width: 220, flex: 1, },
        ...
        <>
            ...
            >
                <Grid item xs={12} sm={12}>
                    <Title title="Interno Consultar estado de una solicitud - PQRSDF" />
                </Grid>
  {/* {id_persona} */}
