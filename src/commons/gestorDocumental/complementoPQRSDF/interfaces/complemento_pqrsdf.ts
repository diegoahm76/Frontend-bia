...
export interface IPqrsdf {
  ...
  complement_pqrs: IObjComplementPqr[];
  complement_pqr: IObjComplementPqr;
...
export interface IObjComplementPqr {
  idComplementoUsu_PQR?: number | null; // id de pqr
  modo_solicitud_complemento?: string | null; // medio de entrega de documentacion
  numero_radicado_complemento?: string | null; // tipó de pqr
  anexos?: IObjExhibit[];
  cod_relacion_con_el_titular?: string | null; //relacion entre persona titular y persona que interpone
  fecha_complemento?: string | Date | null; // fecha creación pqr
  asunto?: string | null; // asunto de pqr
  descripcion?: string | null; // descripcion pqr
  cantidad_anexos?: number | null;// total de anexos
  nro_folios_totales?: number | null; // total folios en anexos
  ...
  fecha_integracion_solic_origen?: string | null; 
  id_PQRSDF?: number | null;
  id_solicitud_usu_PQR?: number | null;
  id_persona_interpone?: number | null;// id de la persona que interpone
  id_medio_solicitud_comple?: number | null; // id medio de entrega de documentacion
  id_persona_recibe?: number | null; // id persona que crea
  id_radicado?: number | null; // id del radicado
