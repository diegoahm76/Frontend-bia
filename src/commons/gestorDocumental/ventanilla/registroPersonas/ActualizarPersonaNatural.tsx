...
import { CustomSelect } from '../TablaGeneral/CustomSelect';
                ...
                <>
                  ...
                  <Grid item xs={12} sm={6} md={4}>
                    <CustomSelect
                      ...
                      disabled={departamento_residencia === ''}
                      errors={errors}
                      register={register}
                    />
                  </Grid>
            ...
            <Grid container spacing={2} mt={0.1}>
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  rows="3"
                  label="Complemento dirección"
                  InputLabelProps={{ shrink: true }} // Esto evita que la etiqueta se superponga
