...
export const PantallaPindicadores = () => {
  ...
  const consultarDatosPqrsdfContestadasOportunamente = async (): Promise<void> => {
    try {
  ...
  const consultarDatosPeticionesContestadasOportunamente = async (): Promise<void> => {
    try {
  ...
  const consultarDatosQuejasContestadasOportunamente = async (): Promise<void> => {
    try {
  ...
  const consultarDatosDenunciasContestadasOportunamente = async (): Promise<void> => {
    try {
