...
import {
  Iinformacion_opa,
  initialDataOpa,
} from '../../interfaces/InterfacesInicializacionJuridicaOpas';
...
export const VistaCompleta = () => {
  const { set_nombre_proyecto, activeStep, id, setActiveStep } =
  ...
  const columns_permisos_ambientales = [
    { field: 'nombre_proyecto', headerName: 'Tipo de Solicitud', width: 600 },
    { field: 'permiso_ambiental', headerName: 'Permiso Abiental', width: 600 },
    {
    ...
    { field: 'radicado', headerName: 'Radicado', width: 250 },
    {
      ...
      renderCell: (params: any) => (
        <>
          <Tooltip title="Ver">
            <IconButton onClick={() => procesoVistaTramiete(params)}>
              <Avatar
                sx={{
                  width: 24,
                  height: 24,
