...
export const AcordeonTramites = (): JSX.Element => {
  //* context declaration
              ...
              <AccordionDetails>
                <Grid container spacing={2}>
                  <Grid item xs={6}>
                    <Typography sx={stylesTypography}>
                      <b>Titular:</b> {item?.detalle?.titular ?? 'No disponible'}
                    </Typography>
                    <Typography sx={stylesTypography}>
                      <b>Nombre del proyecto: </b>
                      {item?.detalle?.nombre_proyecto ?? 'No disponible'}
                    </Typography>
                  </Grid>
                  <Grid item xs={6}>
                    <Typography sx={stylesTypography}>
                      <b>Costo del proyecto: </b>
                      {item?.detalle?.costo_proyecto ?? 'No disponible'}
                    </Typography>
                    <Typography sx={stylesTypography}>
                      <b>Cantidad de predios: </b>
                      {item?.detalle?.cantidad_predios ?? 'No disponible'}
                    </Typography>
                  </Grid>
                </Grid>
                ...
                {!item?.detalle?.solicitud_actual.length ? (
                  ...
                  >
                    <VisaulTexto
                      elements={[
                        'No se ha encontrado información relacionada a la solicitud actual',
                      ]}
                    />
                  </section>
                ) : (
