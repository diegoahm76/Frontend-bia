...
import { getAnexosTramite } from '../../../../toolkit/thunks/TramitesyServiciosyRequerimientos/anexos/getAnexosTramites.service';
...
export const ModalTramitesServicio = (): JSX.Element => {
  // ? redux states use
  ...
  return (
    <>
      ...
      >
        <Box component="form">
          <DialogTitle>
            <Title title="Información del trámite seleccionado" />
          </DialogTitle>
          <Divider />
          <DialogContent
            sx={{
            ...
            >
              ...
              >
                <TextField
                  fullWidth
                  disabled
                  label="Estado actual solicitud del trámite"
                  size="small"
                  variant="outlined"
                  value={
                    currentElementPqrsdComplementoTramitesYotros?.estado_actual_solicitud
                    ??
                    'N/A'
                  }
                  InputLabelProps={{ shrink: true }}
