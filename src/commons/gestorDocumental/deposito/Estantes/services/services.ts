...
// ? ----------------------------------------------- [ GET ] -----------------------------------------------
export const listar_orden_estantes =
    async (): Promise<ListarOrdenSiguiente> => {
        const response = await api.get(
            `gestor/depositos-archivos/estanteDeposito/siguiente-orden/`
        );
...
export const search_deposito = async ({
    ...
    const url = `gestor/depositos-archivos/estanteDeposito/buscar-deposito/?nombre_deposito=${String(
        ...
        identificacion_por_entidad ?? ''
    )}&nombre_sucursal=${String(nombre_sucursal ?? '')}`;
...
export const search_estante = async ({
    ...
    const url = `gestor/depositos-archivos/bandejaEstante/buscar-estante/?identificacion_estante=${String(
        identificacion_estante ?? ''
    )}&orden_estante=${String(orden_estante ?? '')}&nombre_deposito=${typeof nombre_deposito === 'string'
            ? nombre_deposito
            : nombre_deposito?.value ?? ''
        }`;
...
// * estantes por d
export const get_estantes_deposito = async (
    id_deposito: number
): Promise<GetEstantes[]> => {
...
export const get_bandejas_estante = async (
    id_estante: number
): Promise<GetBandejas[]> => {
...
// ? ----------------------------------------------- [ POST ] -----------------------------------------------
export const post_estante = async (
    data: PostEstantes
): Promise<PostEstantes> => {
    const response = await api.post(
        `gestor/depositos-archivos/estanteDeposito/crear/`,
        data
    );
    return response.data;
};
// ? ----------------------------------------------- [ PUT ] -----------------------------------------------
export const put_mover_estante = async (
    identificacion: string,
    data: PutMoverEstantes
): Promise<PutMoverEstantes> => {
    const response = await api.put(
        `gestor/depositos-archivos/estanteDeposito/mover-estante/${identificacion}/`,
        data
    );
    return response.data;
};

export const put_editar_estante = async (
    id: number,
    data: any
): Promise<any> => {
    const response = await api.put(
        `gestor/depositos-archivos/estanteDeposito/actualizar-estante/${id}/`,
        data
    );
    return response.data;
};
...
export const delete_estante = async (id: number): Promise<any> => {
    const response = await api.delete(
        `gestor/depositos-archivos/estanteDeposito/eliminar/${id}/`
    );
    return response.data;
};
