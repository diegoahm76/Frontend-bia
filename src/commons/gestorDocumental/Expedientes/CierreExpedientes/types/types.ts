export interface ExpedienteDocumental {
  ...
  id_und_seccion_propietaria_serie: number;
  nombre_unidad_org: string;
  id_serie_origen: number;
  nombre_serie_origen: string;
  id_subserie_origen: number;
  nombre_subserie_origen: string;
  id_trd_origen: number;
  nombre_trd_origen: string;
  fecha_apertura_expediente: string;
}

export interface SelectTipologias {
  id_tipologia_documental: number | string;
  nombre: string;
}
