...
export const ParametrosReferencia: React.FC = () => {
    ...
    const columns: GridColDef[] = [
        { field: 'id_parametro_referencia', headerName: 'No. PARAMETRO', width: 90 },
        { field: 'nombre_estacion', headerName: 'ESTACIÓN', width: 140 },
        { field: 'fecha_modificacion', headerName: 'FECHA MODIFICACIÓN', width: 140 },
        { field: 'frecuencia_solicitud_datos', headerName: 'FRECUENCIA', width: 90 },

        { field: 'temperatura_ambiente_max', headerName: 'TEMPERATURA MAX', width: 100 },
        { field: 'temperatura_ambiente_min', headerName: 'TEMPERATURA MIN', width: 100 },
        ...
        { field: 'velocidad_viento_max', headerName: 'VEL. VIENTO MAX', width: 100 },
        { field: 'velocidad_viento_min', headerName: 'VEL. VIENTO MIN', width: 100 },

        { field: 'direccion_viento_max', headerName: 'DIR. VIENTO MAX', width: 100 },
        { field: 'direccion_viento_min', headerName: 'DIR. VIENTO MIN', width: 100 },
        ...
        { field: 'nombre_persona_modifica', headerName: 'PERSONA MÓDIFICA', width: 200 },
