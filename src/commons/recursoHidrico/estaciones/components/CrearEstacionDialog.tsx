...
export const CrearEstacionDialog: React.FC<IProps> = ({
  ...
  return (
    <Dialog open={is_modal_active} onClose={handle_close} maxWidth="xs">
      <Box component="form" onSubmit={handleSubmit(on_sumbit_estacion)}>
          ...
          <Grid container spacing={1}>
            <Grid item xs={12}>
              <TextField
                ...
                helperText={
                  errors.nombre_estacion?.type === 'required'
                    ? 'Este campo es obligatorio'
                    : errors.nombre_estacion?.type === 'pattern'
                    ? 'El nombre debe tener de 3 a 30 caracteres y solo letras mayúsculas o minúsculas'
                    : ''
                }
              />
            </Grid>
            ...
            <Grid item xs={12}>
              <TextField
                ...
                helperText={
                  errors.latitud != null ? 'Este campo es obligatorio' : ''
                }
              />
            </Grid>
            <Grid item xs={12}>
              <TextField
                ...
                helperText={
                  errors.longitud != null ? 'Este campo es obligatorio' : ''
                }
              />
            </Grid>
            <Grid item xs={12}>
            ...
            <Grid item xs={12}>
              <TextField
                ...
                helperText={
                  errors.indicaciones_ubicacion != null
                    ? 'Este campo es obligatorio'
                    : ''
                }
              />
        ...
        <DialogActions>
          ...
          <Button
            variant="contained"
            color="primary"
            onClick={handleSubmit(on_sumbit_estacion)}
          >
            Guardar
          </Button>
        </DialogActions>
