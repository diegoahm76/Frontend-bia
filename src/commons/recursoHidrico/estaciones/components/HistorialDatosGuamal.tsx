...
import { consultar_datos_guamal_paginado } from '../../requets/Request';
...
export const HistorialDatosGuamal: React.FC = () => {
    const [dato, set_dato] = useState<Datos[]>([]);

    const historial_datos = async (): Promise<void> => {
        try {
            const response = await consultar_datos_guamal_paginado();
