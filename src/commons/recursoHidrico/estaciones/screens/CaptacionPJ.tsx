...
export const CaptacionPJ: React.FC = () => {
  ...
  const columns: Column[] = [
    ...
    { id: 'caudalConcesionado', label: 'Caudal Concesionado (lts/seg)', minWidth: 250},
    ...
    { id: 'departamentoCaptacion', label: 'Departamento Captación', minWidth: 200 },
    { id: 'municipioCaptacion', label: 'Municipio Captación', minWidth: 200 },
    { id: 'tipoCentroPobladoCaptacion', label: 'Tipo Centro Poblado', minWidth: 200 },
    { id: 'nombreCentroPobladoCaptacion', label: 'Nombre Centro Poblado', minWidth: 190 },
    ...
    { id: 'ofertaHidricaTotal', label: 'Oferta Hídrica Total Año Medio (m3/s)', minWidth: 250},
    { id: 'areaCaptacion', label: 'Área Captación (m2)', minWidth: 250},
    { id: 'ofertaHidricaDisponible', label: 'Oferta Hídrica Disponible Año Medio (m3/s)', minWidth: 250},
    { id: 'tieneSistemaMedicion', label: '¿Tiene Sistema de Medición?', minWidth: 200 },
    { id: 'estadoCaptacion', label: 'Estado Captación', minWidth: 200 },
    { id: 'caudalDisenoCaptacion', label: 'Caudal de Diseño Captación (lts/seg)', minWidth: 250},
    { id: 'tieneContinuidadServicio', label: '¿Tiene Continuidad en el Servicio?', minWidth: 200 },
    ...
    { id: 'descripcionAccesoCaptacion', label: 'Descripción Acceso Captación', minWidth: 300 },
    { id: 'caudal', label: 'Caudal (lts/seg)', minWidth: 250},
    { id: 'noPersonasPermanentes', label: 'No. Personas Permanentes', minWidth: 250},
    { id: 'noPersonasTransitorias', label: 'No. Personas Transitorias', minWidth: 250},
    ...
    { id: 'produccionCultivo', label: 'Producción Cultivo (ton/año)', minWidth: 250},
