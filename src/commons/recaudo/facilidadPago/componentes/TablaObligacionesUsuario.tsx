...
import { Checkbox, Stack, Card, CardContent } from '@mui/material';
...
export const TablaObligacionesUsuario = ({
  showButtonExport,
  columns,
  rowsData,
  tittle,
  ...
  return (
    <>
      ...
      <DataTable
        ...
        value={filtered_data}
        header={header}
        style={{ maxWidth: desktop_open ? 'calc(100vw - 350px)' : '94vw' }}
      ...
      >
        ...
        <Column
          header="[Solicitar Fac. Pago]"
          field='solicitarFacPago'
          body={
            <Checkbox
