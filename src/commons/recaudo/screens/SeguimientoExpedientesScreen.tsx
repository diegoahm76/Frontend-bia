...
export const SeguimientoExpendientes: React.FC = () => {
  ...
  const columns_carteras: GridColDef[] = [
    ...
    {
      field: 'id_deudor',
      headerName: 'FECHA APROX DE PRESCRIPCION',
      minWidth: 160,
      flex: 1,
      valueGetter: (params) => {
        if (!params.value) {
    ...
    },
    {
      ...
      headerName: 'No RESOLUCION MANDAMIENTO DE PAGO',
      minWidth: 200,
      flex: 1,
      valueGetter: (params) => {
    ...
    },
    {
      ...
      headerName: 'FECHA (DD/MM/AA) EXPEDICION MANDAMIENTO DE PAGO',
      minWidth: 160,
      flex: 1,
    },
    {
      field: 'numero_factura',
      headerName: 'MARQUE CON O SIN MEDIDA PREVENTIVA',
      minWidth: 160,
      flex: 1,
    },
    {
      field: 'dias_mora',
      headerName: 'FECHA (DD/MM/AA) NOTIFICACION MANDAMIENTO',
      minWidth: 160,
      flex: 1,
      renderCell: (params) => {
    ...
    },
    {
      ...
      headerName: 'FECHA (DD/MM/AA) VENCIMIENTO TERMINOS PARA INTERPOSICION',
      minWidth: 160,
      flex: 1,
      valueGetter: (params) => {
        if (!params.value) {
    ...
    {
      field: 'id_categoria',
      headerName: 'FECHA (DD/MM/AA) INTERPOSICION DE EXCEPCIONES',
      minWidth: 160,
      flex: 1,
      valueGetter: (params) => {
    ...
    {
      field: 'monto_inicial',
      headerName: 'No RESOLUCION QUE RESUELVE EXCEPCIONES',
      minWidth: 200,
      flex: 1,
    },
    {
      field: 'valor_intereses',
      headerName: 'FECHA (DD/MM/AA) RESOLUCION QUE RESUELVE EXCEPCIONES',
      minWidth: 160,
      flex: 1,
    },
    {
      field: 'codigo_contable',
      headerName: 'FECHA (DD/MM/AA) NOTIFICACION RESUELTA EXCEPCION',
      minWidth: 160,
      flex: 1,
    },
    {
      field: 'valor_sancion',
      headerName: 'FECHA (DD/MM/AA) SOLICITUD DE ACUERDO DE PAGO',
      minWidth: 160,
      flex: 1,
    },
    {
      field: 'valor_sancion',
      headerName: 'No RESOLUCION ACUERDO DE PAGO',
      minWidth: 160,
      flex: 1,
    },
    {
      field: 'valor_sancion',
      headerName: 'ESTADO DEL ACUERDO DE PAGO',
      minWidth: 160,
      flex: 1,
    },
    {
      field: 'valor_sancion',
      headerName: 'No RES QUE ORDENA SEGUIR ADELANTE EJECUCION',
      minWidth: 160,
      flex: 1,
    },
    {
      field: 'valor_sancion',
      headerName: 'FECHA (DD/MM/AA) RESOLUCION QUE ORDENA SEGUIR ADELANTE',
      minWidth: 160,
      flex: 1,
    },
    {
      field: 'valor_sancion',
      headerName: 'FECHA (DD/MM/AA) NOTIFICACION RESOLUCION ORDENA SEGUIR ADELANTE ',
      minWidth: 160,
      flex: 1,
    },
    {
      field: 'valor_sancion',
      headerName: 'No RESOLUCION DE LIQUIDACION DE CREDITO Y COSTAS DE LA SENT',
      minWidth: 160,
      flex: 1,
    },
    {
      field: 'valor_sancion',
      headerName: 'FECHA (DD/MM/AA) EXPEDICION RESOLUCION LIQUIDACION DE CREDITO',
      minWidth: 160,
      flex: 1,
    },
    {
      field: 'valor_sancion',
      headerName: 'FECHA (DD/MM/AA) NOTIFICACION LIQUIDACION DEL CREDITO',
      minWidth: 160,
      flex: 1,
    },
    {
      field: 'valor_sancion',
      headerName: 'ESTADO LIQUIDACION',
      minWidth: 160,
      flex: 1,
    },
    {
      field: 'valor_sancion',
      headerName: 'MEDIDAS CAUTELARES EJECUTADAS',
      minWidth: 160,
      flex: 1,
    },
    {
      field: 'valor_sancion',
      headerName: 'INVESTIGACION DE BIENES',
      minWidth: 160,
      flex: 1,
    },
    {
      field: 'valor_sancion',
      headerName: 'FECHA (DD/MM/AA) Y ULTIMA ACTUACION',
      minWidth: 160,
      flex: 1,
    },
    {
    ...
    {
      field: 'valor_sancion',
      headerName: 'ACTUACION PENDIENTE',
      minWidth: 160,
      flex: 1,
    },
    {
      field: 'valor_sancion',
      headerName: 'PROCESO ARCHIVADO (A) EN CURSO (C)',
      minWidth: 160,
      flex: 1,
    },
    {
  ...
  return (
    <>
      ...
      >
        <Grid item xs={12}>
          <Title title="Seguimiento Expedientes"></Title>
        </Grid>
        <Grid item xs={12} mt={1} sx={{display: 'flex', gap: '1rem'}}>
          <TextField
            label='Nombres'
            size='small'
