import { Box, Button, Checkbox, Dialog, DialogActions, DialogContent, DialogTitle, Divider, FormControl, Grid, InputLabel, MenuItem, Select, type SelectChangeEvent, Stack, TextField } from "@mui/material"
...
export const DetalleModal:React.FC<IProps> = ({ is_modal_active ,set_is_modal_active }: IProps) => {
