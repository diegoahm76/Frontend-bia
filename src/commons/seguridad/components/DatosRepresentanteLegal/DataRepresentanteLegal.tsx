...
> = ({ id_representante_legal,
  ...
  set_id_reoresentante_legal,
    ...
    const [fecha_inicio_representante, set_fecha_inicio_representante] = useState<Dayjs | null>(null);

    const handle_change_fecha_inicio_representante = (value: Dayjs | null): void => {
                    ...
                    <DatePicker
                      ...
                      renderInput={(params) => (
                        <TextField
                          ...
                          size="small"
                          {...params}
                          {...register('fecha_inicio_cargo_rep_legal', { required: true })}
                          error={errors.fecha_inicio_representante?.type === 'required'}
                          helperText={
