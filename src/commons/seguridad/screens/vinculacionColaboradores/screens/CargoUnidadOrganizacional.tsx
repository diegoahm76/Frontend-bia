...
const CargoUnidadOrganizacionalComponent = (props: IProps) => {
    ...
    const [fecha_desvinculacion, set_fecha_desvinculacion] = useState<Dayjs>(dayjs());
    ...
    const [msj_error_justificacion, set_msj_error_justificacion] = useState<string>("");
    ...
    useEffect(() => {
        if (props.persona_vinculacion !== null && props.persona_vinculacion !== undefined) {
            ...
            set_fecha_desvinculacion(props.persona_vinculacion.fecha_desvinculacion);
            set_obs_vin_cargo(props.persona_vinculacion.obs_vin_cargo);
            set_justificacion(props.persona_vinculacion.justificacion);
            set_desvincular(props.persona_vinculacion.desvincular);
    ...
    const cambio_obs_vin_cargo: any = (e: React.ChangeEvent<HTMLInputElement>) => {
        set_obs_vin_cargo(e.target.value);
        if (e.target.value !== "")
            set_msj_error_obs_vin_cargo("");
    };

    const cambio_obs_desvincula: any = (e: React.ChangeEvent<HTMLInputElement>) => {
        set_obs_desvincula(e.target.value);
        if (e.target.value !== "")
            set_msj_error_obs_desvincula("");
    };

    const cambio_justificacion: any = (e: React.ChangeEvent<HTMLInputElement>) => {
        set_justificacion(e.target.value);
        if (e.target.value !== "")
            set_msj_error_justificacion("");
    };
    ...
    const valida_formulario = (): boolean => {
        ...
        if (desvincular && obs_desvincula === ""){
            set_msj_error_obs_desvincula("El campo Observación de la desvinculación es obligatorio.");
            validador = false;
        }
        return validador;
    }
                            ...
                            <Box component="form" sx={{ mt: '20px' }} noValidate autoComplete="off">
                                <Grid item container spacing={2}>
                                    <Grid item xs={12} sm={4}>
                                        ...
                                        {(msj_error_cargo !== "") && (<FormHelperText error >{msj_error_cargo}</FormHelperText>)}
                                    </Grid>
                                    <Grid item xs={12} sm={4}>
                                    ...
                                    <Grid item xs={12} sm={4}>
                                        <LocalizationProvider dateAdapter={AdapterDayjs}>
                                            <DatePicker
                                                ...
                                                onChange={(newValue) => { cambio_fecha_finaliza(newValue); }}
                                                renderInput={(params) => (
                                                    <TextField
                                                        required
                                                        fullWidth
                        ...
                        <Grid item md={12} xs={12}>
                            ...
                            <Box component="form" sx={{ mt: '20px' }} noValidate autoComplete="off">
                                <Grid item container spacing={2}>
                                    ...
                                    {(msj_error_justificacion !== "") && (<FormHelperText error >{msj_error_justificacion}</FormHelperText>)}
                                </Grid>
                            </Box>
                        </Grid>
                    </Grid>
                    {props.persona_vinculacion !== null && (<Grid
                        container
                        sx={{
                            position: 'relative',
                            background: '#FAFAFA',
                    ...
                    >
                        <Grid item md={12} xs={12}>
                            ...
                            <Box component="form" sx={{ mt: '20px' }} noValidate autoComplete="off">
                                <Grid item container spacing={2}>
                                    <Grid item xs={12} sm={6}>
                                        ...
                                        >
                                            <FormLabel sx={{ mt: '9px', mx: '10px' }}>Desvincular: </FormLabel>
                                            <ToggleButton
                                                value="check"
                            ...
                            <Box component="form" sx={{ mt: '20px' }} noValidate autoComplete="off">
                                ...
                                {(msj_error_obs_desvincula !== "") && (<FormHelperText error >{msj_error_obs_desvincula}</FormHelperText>)}
                            </Box>
                        </Grid>
                    </Grid>)}
                </DialogContentText>
