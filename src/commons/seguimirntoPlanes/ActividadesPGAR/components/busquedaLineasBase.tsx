...
import { search_linea, search_meta } from '../../SeguimientoPGAR/services/services';
import { IBusquedaLineas, IBusquedaMetas } from '../../SeguimientoPGAR/utils/types';
// eslint-disable-next-line @typescript-eslint/naming-convention
export const BusquedaLineaBase: React.FC = () => {
    ...
    const on_submit_advance = handle_submit(async ({ nombre_meta_eje, nombre_linea }) => {
      set_is_search(true);
      try {
        set_rows([]);
        const {
    ...
    return (
      <>
        ...
        >
          <Grid item xs={12}>
            <Title title="Búsqueda de Líneas Base" />
          </Grid>
          <Grid item xs={12}>
            <Divider />
          </Grid>
        ...
        <Dialog open={open_dialog} onClose={handle_close} fullWidth maxWidth="lg">
          <DialogContent>
            ...
            >
              <Title title="Búsqueda avanzada Líneas Base" />
