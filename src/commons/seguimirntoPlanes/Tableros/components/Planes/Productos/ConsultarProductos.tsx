...
import { columsProductos } from './colums';
// eslint-disable-next-line @typescript-eslint/naming-convention
export const ConsultarProductos: React.FC = () => {
  ...
  const { rows_productos } = useConsultaMetasHook();
  ...
  useEffect(() => {
    const cumplidoTrue = rows_productos.filter(
      (row: { cumplio: boolean }) => row.cumplio === true
    ).length;
    const cumplidoFalse = rows_productos.filter(
