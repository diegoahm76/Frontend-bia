...
interface Historico {
  ...
  const columns = [
    ...
    { field: 'valor_meta', headerName: 'Valor meta      ', flex: 1, renderCell: (params: any) => {
          ...
          <Grid item>
            <Button
              ...
              disabled={!formData.plan || !formData.tablero} 
                onClick={() =>{consultarSeguimiento(),fetchHistorico( )}}
            >
              Buscar
            </Button>
          </Grid>
...
>
  ...
  <div style={{ marginRight: '-20px' ,fontWeight: 'bold'}}>EJES</div>
...
>
  ...
  <div style={{ marginRight: '-20px' ,fontWeight: 'bold'}}>PROGRAMAS</div>
...
>
<div style={{ marginRight: '-20px' ,fontWeight: 'bold'}}>PROYECTO</div>
...
>
<div style={{ marginRight: '-20px' ,fontWeight: 'bold'}}>PRODUCTOS</div>
...
>
<div style={{ marginRight: '-20px' ,fontWeight: 'bold'}}>ACTIVIDAD</div>
...
>
<div style={{ marginRight: '-20px' ,fontWeight: 'bold'}}>INDICADOR</div>
...
>
<div style={{ marginRight: '-20px' ,fontWeight: 'bold'}}>META</div>
  ...
  sx={{
    ...
    justifyContent: 'center',
    position: 'relative',
    background: 'linear-gradient(to right, #cce7ff, #49a2ff)',    borderRadius: '15px',
    p: '20px',
    m: '10px 0 20px 0',
    mb: '20px',
    height: '100px',
...
<Grid
  ...
  sx={{
    ...
    justifyContent: 'center',
    position: 'relative',
    background: 'linear-gradient(to right, #ffdc9a, #ff7c7c)',   borderRadius: '15px',
    p: '20px',
    m: '10px 0 20px 0',
    mb: '20px',
    height: '100px',
...
<Grid
  ...
  sx={{
    ...
    justifyContent: 'center',
    position: 'relative',
    background: 'linear-gradient(to right, #fba1ff, #6c63ff)',   borderRadius: '15px',
    p: '20px',
    m: '10px 0 20px 0',
    mb: '20px',
    height: '100px',
