...
import { search_actividad, search_linea, search_meta } from '../../SeguimientoPGAR/services/services';
import { IBusquedaLineas, IBusquedaMetas } from '../../SeguimientoPGAR/utils/types';
// eslint-disable-next-line @typescript-eslint/naming-convention
export const BusquedaActividadesPgar: React.FC = () => {
            ...
            <IconButton
              ...
              onClick={() => {
                ...
                reset({
                  ...
                  nombre_meta_eje: params.row.nombre_meta,
                  nombre_linea: params.row.nombre_linea_base,
    ...
    const [rows, set_rows] = useState<IBusquedaLineas[]>([]);
    ...
    const on_submit_advance = handle_submit(async ({ nombre_meta_eje, nombre_linea, nombre_actividad, nombre_eje_estrategico }) => {
      set_is_search(true);
      try {
        set_rows([]);
        const {
    ...
    return (
      <>
        ...
        >
          <Grid item xs={12}>
            <Title title="Búsqueda de Actividades" />
          </Grid>
          <Grid item xs={12}>
            <Divider />
          </Grid>
